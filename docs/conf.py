...
extlinks = {
    'issue': ('https://github.com/sphinx-notes/poc/issues/%s', '💬%s'),
    'pull': ('https://github.com/sphinx-notes/poc/pull/%s', '🚀%s'),
    'tag': ('https://github.com/sphinx-notes/poc/releases/tag/%s', '🏷️%s'),
}
